...
int main()
{
	...
	floor->material = material(create_color(0.9, 0.9, 0.9), 0.1, 0.9, 0, 200.0, 1);
	...
	middle->material = material(create_color(0.1, 1, 0.5), 0.1, 0.7, 0.3, 200.0, 1);
	...
	right->material = material(create_color(0.5, 1, 0.1), 0.1, 0.7, 0.3, 200.0, 0);
	...
	left->material = material(create_color(1, 0.8, 0.1), 0.1, 0.7, 0.3, 200.0, 1);
	world.shapes[4] = left;
