...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/07 15:31:00 by irychkov          #+#    #+#             */
/*   Updated: 2025/02/07 18:13:28 by irychkov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	floor->material = material(create_color(0.9, 0.9, 0.9), 0.1, 0.9, 0, 200.0, 4);
	...
	middle->material = material(create_color(0.1, 1, 0.5), 0.1, 0.7, 0.3, 200.0, 3);
	...
	right->material = material(create_color(0.816, 0.753, 0.98), 0.1, 0.7, 0.3, 200.0, 2);
	...
	left->material = material(create_color(1, 1, 1), 0.1, 0.7, 0.3, 200.0, 1);
	...
	canvas_to_ppm(canvas, "patterns_all1.ppm");
