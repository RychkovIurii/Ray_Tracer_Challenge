...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/07 11:01:27 by irychkov          #+#    #+#             */
/*   Updated: 2025/02/07 12:40:22 by irychkov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	floor->material = material(create_color(0.9, 0.9, 0.9), 0.1, 0.9, 0, 200.0);
	...
	ceil->material = material(create_color(0.6, 0.6, 0.6), 0.1, 0.9, 0, 200.0);
	world.shapes[1] = ceil;
	...
	canvas_to_ppm(canvas, "scene_with_floor.ppm");
